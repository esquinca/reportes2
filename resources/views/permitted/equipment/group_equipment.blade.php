          ...
          <div class="box box-solid">
            <div class="box-body">
                <div class="form-inline">
                  ...
                  <input type="text" id="new_group" name="new_group"></input>
                  <div style="padding-top: 1%">
                    ...
                    <select id="select_one" name="select_one"  class="form-control select2" style="width: 60%" required>
                      ...
                      @forelse ($grupos as $data_grupos)
                        <option value="{{ $data_grupos->Nombre_Grupo }}">{{ $data_grupos->Nombre_Grupo }}</option>
                      @empty
                      @endforelse
                    </select>
                    <label for="mac_input" class="control-label">{{ trans('message.ingmac') }}: </label>
                    <input type="text" id="mac_input" name="mac_input"></input>
